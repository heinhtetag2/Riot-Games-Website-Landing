import svgPaths from "./svg-py5csr8h9n";
...
import imgValHomepageProductcardS26Png1 from "figma:asset/bbcf3375935bcd9b136357d8b3680afc14a6bc04.png";
...
import { imgBackground, imgBackground1, imgBackground2, imgBackground3, imgBackground4, imgBackground5, imgBackground6, imgBackground7, imgBackground8 } from "./svg-maol7";
...
function ValHomepageProductcardS26Png1() {
  return (
    <div className="absolute h-[580.95px] left-0 top-0 w-[345.89px]" data-name="val-homepage-productcard-s26.png">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-[100.02%] left-0 max-w-none top-[-0.01%] w-full" src={imgValHomepageProductcardS26Png1} />
      </div>
    </div>
  );
}
...
function Background3() {
  return (
    <div className="absolute aspect-[243.44000244140625/408.8699951171875] bg-[#808080] left-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0%_0px] mask-size-[100%_408.88px] right-[-0.18px] top-0" data-name="Background" style={{ maskImage: `url('${imgBackground2}')` }}>
      <Container18 />
    </div>
  );
}
...
function Link3() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[83.67px] pr-[77.65px] pt-[109.95px] relative size-full" data-name="Link">
      <MaskGroup6 />
    </div>
  );
}
...
function Background4() {
  return (
    <div className="absolute aspect-[230.61000061035156/387.3299865722656] bg-[#808080] left-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0%_0px] mask-size-[100%_387.33px] right-[0.66px] top-0" data-name="Background" style={{ maskImage: `url('${imgBackground3}')` }}>
      <Container24 />
    </div>
  );
}
...
function Link4() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[93.75px] pr-[80.06px] pt-[121.41px] relative size-full" data-name="Link">
      <MaskGroup7 />
    </div>
  );
}
...
function Background5() {
  return (
    <div className="absolute aspect-[217.77999877929688/365.7900085449219] bg-[#808080] left-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0%_0px] mask-size-[100%_365.763px] right-[0.5px] top-0" data-name="Background" style={{ maskImage: `url('${imgBackground4}')` }}>
      <Container28 />
    </div>
  );
}
...
function Link5() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[103.98px] pr-[82.47px] pt-[132.72px] relative size-full" data-name="Link">
      <MaskGroup8 />
    </div>
  );
}
...
function Background6() {
  return (
    <div className="absolute aspect-[205/344.32000732421875] bg-[#808080] left-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0%_0px] mask-size-[100%_344.31px] right-[-0.44px] top-0" data-name="Background" style={{ maskImage: `url('${imgBackground5}')` }}>
      <Container33 />
    </div>
  );
}
...
function Link6() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[114.33px] pl-[4.85px] pr-[84.87px] pt-[143.84px] relative size-full" data-name="Link">
      <MaskGroup9 />
    </div>
  );
}
...
function Background7() {
  return (
    <div className="absolute aspect-[192.1699981689453/322.7699890136719] bg-[#808080] left-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0%_0px] mask-size-[100%_322.77px] right-[-0.44px] top-0" data-name="Background" style={{ maskImage: `url('${imgBackground6}')` }}>
      <Container37 />
    </div>
  );
}
...
function Link7() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[124.87px] pl-[15.27px] pr-[87.28px] pt-[154.85px] relative size-full" data-name="Link">
      <MaskGroup10 />
    </div>
  );
}
...
function Background8() {
  return (
    <div className="absolute aspect-[179.38999938964844/301.29998779296875] bg-[#808080] left-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0%_0px] mask-size-[100%_301.29px] right-[-0.42px] top-0" data-name="Background" style={{ maskImage: `url('${imgBackground7}')` }}>
      <Container41 />
    </div>
  );
}
...
function Link8() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[135.53px] pl-[25.65px] pr-[89.67px] pt-[165.66px] relative size-full" data-name="Link">
      <MaskGroup11 />
    </div>
  );
}
...
function Background9() {
  return (
    <div className="absolute aspect-[179.36000061035156/301.239990234375] bg-[#808080] left-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0%_0px] mask-size-[100%_301.25px] right-[-0.44px] top-0" data-name="Background" style={{ maskImage: `url('${imgBackground8}')` }}>
      <Container46 />
    </div>
  );
}
...
function Link9() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[135.56px] pl-[25.68px] pr-[89.68px] pt-[165.69px] relative size-full" data-name="Link">
      <MaskGroup12 />
    </div>
  );
}
...
function Container() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[602px] left-1/2 top-[calc(50%+0.5px)] w-[941px]" data-name="Container">
      <Frame />
      <div className="absolute flex inset-[0_-1685.1px_-0.49px_2414.19px] items-center justify-center">
        <div className="-scale-y-100 flex-none h-[602.49px] rotate-180 w-[211.91px]">
          <Link3 />
        </div>
      </div>
      <div className="absolute flex inset-[0_-1990.24px_-0.49px_2708.91px] items-center justify-center">
        <div className="-scale-y-100 flex-none h-[602.49px] rotate-180 w-[222.33px]">
          <Link4 />
        </div>
      </div>
      <div className="absolute flex inset-[0_-2295.38px_-0.49px_3003.63px] items-center justify-center">
        <div className="-scale-y-100 flex-none h-[602.49px] rotate-180 w-[232.75px]">
          <Link5 />
        </div>
      </div>
      <div className="absolute flex inset-[0_-2595.63px_-0.49px_3298.35px] items-center justify-center">
        <div className="-scale-y-100 flex-none h-[602.49px] rotate-180 w-[238.28px]">
          <Link6 />
        </div>
      </div>
      <div className="absolute flex inset-[0_-2890.35px_-0.49px_3593.07px] items-center justify-center">
        <div className="-scale-y-100 flex-none h-[602.49px] rotate-180 w-[238.28px]">
          <Link7 />
        </div>
      </div>
      <div className="absolute flex inset-[0_-3185.07px_-0.49px_3887.78px] items-center justify-center">
        <div className="-scale-y-100 flex-none h-[602.49px] rotate-180 w-[238.29px]">
          <Link8 />
        </div>
      </div>
      <div className="absolute flex inset-[0_-3479.78px_-0.49px_4182.5px] items-center justify-center">
        <div className="-scale-y-100 flex-none h-[602.49px] rotate-180 w-[238.28px]">
          <Link9 />
        </div>
      </div>
      <div className="absolute flex inset-[0_-3774.5px_-0.49px_4477.22px] items-center justify-center">
        <div className="-scale-y-100 flex-none h-[602.49px] rotate-180 w-[238.28px]">
          <Link10 />
        </div>
      </div>
      <div className="absolute flex inset-[0_-4069.22px_-0.49px_4771.94px] items-center justify-center">
        <div className="-scale-y-100 flex-none h-[602.49px] rotate-180 w-[238.28px]">
          <Link11 />
        </div>
      </div>
      <div className="absolute flex inset-[0_-4363.94px_-0.49px_5066.66px] items-center justify-center">
        <div className="-scale-y-100 flex-none h-[602.49px] rotate-180 w-[238.28px]">
          <Link12 />
        </div>
      </div>
